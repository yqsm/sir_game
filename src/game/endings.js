...
export const ENDING_TEXTS = {
  [ENDINGS.FENLI_ROAD]: {
    ...
    paragraphs: [
      ...
      '他向雨里伸出手。领带的触感还在指尖，薄荷味还没完全散去。他回想起来湿炒牛河的热气——那天在大排档的杨锦荣没有甩脸子。',
    ],
  },
  ...
  [ENDINGS.NO_LOVE_IN_KILLING]: {
    ...
    subtitle: '— 你只是在执法而已 —',
    paragraphs: [
      '他把录音带放进播放机。他的声音，韩琛的声音。存档。归档。证据。',

      '电脑屏幕上，人事系统的备注栏里，那个词——"搁置"',

      '门开了，是保安科的五个人。站在最前面的人递给他一份逮捕令。原来这一切都是杨锦荣设计的。从刘建明第一次踏进这扇门开始，每一步都在计划里。录音带、人事档案、半页报告里被划掉又重写的铅笔字……',
  ...
  [ENDINGS.UNDER_VAST_SKY]: {
    ...
    paragraphs: [
      ...
      '走廊不是保安科的走廊。走廊很长，尽头是一片他无法描述的白。不是刺眼的——是温的，像被什么接住了。白光里站着一个人，穿着制服，肩章上各有一颗银色四角星花。他转过头来。',

      '是杨锦荣。',

      '没有说话。杨锦荣只是看着他。眼神和活着的时候一模一样——锐利，安静，好像已经在这里等了一阵子。',

      '他低头。自己身上是高级督察的制服。领带工整。警官证在口袋里，他掏出来。照片是他。名字是他。警号也是他。',

      '然后他想起来了。',

      '今晚不是今晚。今晚是他死后的第七天。头七。他一直在这间办公室里徘徊，像是在等待一个同样无法回来的人。',
  ...
  [ENDINGS.STOCKHOLM_LOVER]: {
    ...
    paragraphs: [
      ...
      '杨锦荣走近，把领带从他嘴里抽出来，顺着领带把人拉起来，翻了个面按在办公桌上。动作很顺，像是这一切已经发生过一百次。',
  ...
  [ENDINGS.SUSPENDED]: {
    ...
    subtitle: '— 状态：搁置 —',
    paragraphs: [
      '他接了电话。杨锦荣的声音——"你在听吗。"听到了。他本来想说点什么。但电话已经挂了。忙音。',

      '屏幕上那行备注还在。"状态：搁置"。他可以选择往下翻——翻到更深的层级，翻出是谁发起的、为什么搁置、有没有人在等回复。但他没有。他把屏幕关掉了。',

      '搁置。没有结束，也没有继续。他的人生停在这一行备注里。和杨锦荣那份写了一半的报告一样。',
