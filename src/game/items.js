...
export const ITEMS = [
  ...
  },
  {
    ...
    memory: [
      '扬声器里先是一阵杂音。然后——他自己的声音。他正在汇报。韩琛的安插名单、最近的行动细节、下一步的计划。一字一句，清清楚楚。他在向韩琛汇报。',
      '磁带继续转。韩琛的声音。他的声音。又是他的声音。杨锦荣把不止一次通话录了下来——在不同的日期，不同的时间。证据。完整的证据链。',
      '然后——一段很长的空白。嘶嘶的磁带噪声。然后——按键声。然后——杨锦荣的声音：',
  ...
  },
  {
    ...
    memory: [
      ...
      '"如果你还在，有些事情会不一样。"',
      '刘建明想：如果陈永仁还在——杨锦荣的警校同期，那个各项成绩都压他一头的人——他和杨锦荣之间还会有这些东西吗？',
      '也许这些都不重要。反正陈永仁已经死了。',
    ],
  },
  {
